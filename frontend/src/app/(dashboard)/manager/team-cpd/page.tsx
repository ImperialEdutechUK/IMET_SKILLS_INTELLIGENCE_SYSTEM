...
interface Member { id: string; fullName: string; cpdProgress: number; }
...
export default function TeamCpdPage() {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/manager/team-cpd`, {
    ...
    <div>
      ...
      <div className="rounded-xl border border-[var(--border)] bg-white">
        ...
        {data.members.length === 0 ? (
          <p className="p-5 text-sm text-[var(--muted)]">No team members yet.</p>
        ) : (
