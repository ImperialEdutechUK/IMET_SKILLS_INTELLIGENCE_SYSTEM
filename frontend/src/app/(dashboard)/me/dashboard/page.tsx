...
export default function EmployeeDashboardPage() {
  ...
  const kpis = [
    { label: "Certificates earned", value: certCount, sub: g.next ? `${g.toNext} XP to ${g.next.label}` : "all badges earned", icon: ScrollText, accent: "#16a34a", tint: "bg-emerald-50 text-emerald-600", href: "/me/certificates" },
