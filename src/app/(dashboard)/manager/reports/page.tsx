...
export default function ManagerReportsPage() {
  return (
    <div>
      <div className="mb-6"><h1 className="text-2xl font-bold text-[var(--ink)]">Reports</h1><p className="mt-1 text-sm text-[var(--muted)]">Team performance analytics.</p></div>
      ...
      <div className="rounded-xl border border-[var(--border)] bg-white p-5">
        <h3 className="mb-4 font-semibold text-[var(--ink)]">Team Learning Progress</h3>
